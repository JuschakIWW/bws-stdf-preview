...
class TrainOptions(Schema):
    """The information needed to train a model"""
    algorithm = fields.String(description='Algorithm to use for training a forecasting model.', validate=[OneOf(choices=['prophet'], labels=[])])
    ...
    hyperParamSearch = fields.Boolean(description='Whether to perform automated hyperparameter search to find the best set of parameters', missing=lambda: False)
